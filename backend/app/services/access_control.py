...
PERMISSION_DEFINITIONS: list[PermissionOption] = [
    ...
    PermissionOption(key="notify.oncall.view", label="查看值班表", description="查看公司级值班表"),
    PermissionOption(key="notify.oncall.manage", label="管理值班表", description="创建、编辑、删除公司级值班表"),
    PermissionOption(key="notify.push_log.view", label="查看推送日志", description="查看告警推送日志"),
    PermissionOption(key="notify.push_log.retry", label="重发失败推送", description="对失败推送执行重发"),
